...
# Global RMSD calculation script for all proteins.
# Runs cli-global.py with --stat rmsd and writes per-protein CSV/log outputs.
# Usage: ./cli-global-rmsd.sh
...
echo "Starting global RMSD calculations for all proteins..."
echo ""
...
for protein in "${proteins[@]}"; do
    ...
    output_csv="$results_dir/${protein_lower}-global-rmsd.csv"
    output_log="$logs_dir/${protein_lower}-global-rmsd.stderr.log"
...
echo "All global RMSD calculations complete."
