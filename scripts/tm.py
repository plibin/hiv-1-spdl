...
def global_tm(id_: str,
    ...
    # Normalize by the reference length represented in the alignment.
    L_N = sum(1 for aa in ref_align if aa != "-")
    if L_N == 0:
        raise ValueError("Reference alignment contains no residues")
