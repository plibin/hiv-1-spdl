...
# Positional RMSD calculation script for all proteins.
# Iterates over each protein in config.py, runs cli-pos.py with --stat rmsd,
# and writes results to CSV and warnings to log files in the results directory.
# Usage: ./cli-pos-rmsd.sh
...
echo "Starting positional RMSD calculations for all proteins..."
echo ""
...
echo "All positional RMSD calculations complete."
